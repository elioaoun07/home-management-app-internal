...
| E28 | [Proactive architectural leverage](<../ERA Notes/10 - Project Management/Proactive ERA/Proactive ERA — Architectural Leverage.md>); [signal/knowledge study](<../ERA Notes/10 - Project Management/Proactive ERA/Proactive ERA — Signal & Knowledge Graph.md>); [Top Layer plan](<../ERA Notes/10 - Project Management/ERA Top Layer — Master Plan (2026-09-02).md>), decision register and anti-plan | Existing proposed evidence/situation/receipt contracts and execution constraints |
...
| B12 | [Offline queue](../src/lib/offlineQueue.ts), feature union at 14 and enqueue path; [replay engine](../src/lib/offlineSyncEngine.ts), lines 190–279; [Top Layer ASTRA packets](<../ERA Notes/10 - Project Management/Top Layer/Top Layer — ASTRA Packets.md>); [Top Layer plan](<../ERA Notes/10 - Project Management/ERA Top Layer — Master Plan (2026-09-02).md>), D17/E-04/E-08/E-09 | Current retry identity/retention gaps and existing owning packets; future queue safety cannot be assumed |
