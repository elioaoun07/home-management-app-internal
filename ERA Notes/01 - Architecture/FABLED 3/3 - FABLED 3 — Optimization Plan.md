...
# Architecture · FABLED 3.3 — Optimization Plan
...
1. Verify the Feature Map has a `healthcare.md` standalone map; add it if missing (new module shipped 07-17).
2. Carry v2's ask: promote memory-enforced rules into hooks/lint where cheap.
