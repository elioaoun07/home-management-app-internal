...
# Standalone Modules · FABLED 3.2 — Gaps & Missing
...
> **Inheritance (verified 2026-07-18):** [FABLED 2 file 2](<../FABLED 2/2 - FABLED 2 — Gaps & Missing.md>) carries **verbatim** — every gap open unless a delta bullet in [3.1](<1 - FABLED 3 — Current Implementation.md>) or the `_index` ledger says it closed.
