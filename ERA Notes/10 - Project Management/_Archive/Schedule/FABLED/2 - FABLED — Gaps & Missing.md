...
>
> Ranked. The UX-level pains live in the Pain Inventory campaign (`../Pain Inventory & Plan/1 - Pain Inventory (Every Painful Thing).md`; historical target absent from the current tree) ⚠️ BROKEN LINK — SCHEDULE PM REORGANIZED 2026-06-19 (see `1 - Feature State & Pain Inventory.md` instead) — this file is the *technical* absence list; don't duplicate the campaign here.
