...
| Same, E-09; [Schedule ASTRA Book](<../ASTRA/Schedule/Schedule — ASTRA Book.md>) | Queue durability, replay identity, partial writes and unsupported recurrence | Successful online and replayed execution of the same supported input produce different effects |
| [Budget ASTRA Book](<../ASTRA/Budget/Budget — ASTRA Book.md>), F1–F6 | Mutable balance races, confirmation/restore gaps and inconsistent projections | An ordinary account metadata change alters the inverse even with perfect serialization |
