...
> ⚠️ **ARCHIVED IN PLACE (2026-07-15)** — historical blueprint; do not treat as current. Current truth: the FABLED 2 layer ([FABLED 2 Master Index](<../00 - Home/FABLED 2 Master Index.md>)). Router: [_index](<_index.md>).
