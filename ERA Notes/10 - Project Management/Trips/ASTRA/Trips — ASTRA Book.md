...
> Subordinate to [ERA Top Layer — Master Plan (2026-09-02)](<../../ERA Top Layer — Master Plan (2026-09-02).md>), not a replacement roadmap. Evidence cutoff `3106164`; [Master Book](<../Trips — Master Book.md>) updated 2026-08-19, read end to end. [Packets](<Trips — ASTRA Packets.md>). Study only; no DB calls.
