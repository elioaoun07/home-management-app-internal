...
- 🟡 Transfer rows are detected and skipped, never imported as transfers (owner-deferred, PM inbox 2026-07-31). The detection is a `transfer from|to` regex, so bank-specific phrasings like "Own Account Exchange" fall through to the review bucket instead of being recognized.
