...
| **Salary -> Wallet quick refill**       | Funding Wallet required opening the full transfer dialog and knowing which accounts to pick                                                                                                                                                                                                             | Direct URL/NFC shortcut opens `/expense`, prompts only for amount, resolves Salary/Wallet by signed-in user's account names _(IMPLEMENTED 2026-06-25)_                                                                                                                                  | S      |
