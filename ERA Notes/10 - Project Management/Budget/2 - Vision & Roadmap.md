...
| **50/30/20 + Dashboard V2 widgets** | Allocation is per-category envelopes | Guided budgeting templates and richer dashboard KPIs | M |
...
| **Allocation auto-suggest from recurring** | Allocations set by hand | Pre-fill envelope minimums from known recurring commitments (gap 2d) | M |
