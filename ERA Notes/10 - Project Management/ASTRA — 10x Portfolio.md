...
> Subordinate to [ERA Top Layer — Master Plan (2026-09-02)](<ERA Top Layer — Master Plan (2026-09-02).md>). Cutoff `3106164`; written last after Phase5 reconciliation. [Register](<ASTRA — Contradiction Register.md>) holds unresolved decisions; [Coverage](<ASTRA — Coverage & Orphans.md>) holds queue ownership and admission.
...
| 2 | Atomic shared balance delta and history | Concurrent writes retain every money effect | One helper protects multiple money paths | High: [Budget F1](<Budget/ASTRA/Budget — ASTRA Book.md>); live DB unverified | M + owner DB gate | NEW BUD-63 |
...
| 4 | Refuse unsupported recurrence before writing | Recurrence cannot silently become a one-time task | Guard initial and pending confirmation | High: [Schedule F3](<Schedule/ASTRA/Schedule — ASTRA Book.md>) | S | DOCKS → E-09; SCH-7 |
...
| 9 | Zero executed tests can never pass validation | “Tested” means a test actually ran | One gate protects all product packets | High: [Delivery F5](<Delivery/ASTRA/Delivery — ASTRA Book.md>) | S; existing prerequisite | EXTENDS → DLV-90 / ASTRA-DLV-4 |
