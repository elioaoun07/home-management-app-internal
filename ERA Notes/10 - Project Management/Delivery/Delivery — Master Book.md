...
- 🟡 Cache-TTL split is measured and instrumented but **no lever exists at the TTL level** — the remedy is the bounded read window plus the merged-phase work, not anything in the TTL itself.
