...
# UI & Design · FABLED 3.3 — Optimization Plan
...
1. Add an Atlas entry for `/healthcare` if missing (new page shipped 07-17 — `node scripts/seed-atlas.mjs` will stub it).
2. Carry v2's instruments ask (visual regression) unchanged.
