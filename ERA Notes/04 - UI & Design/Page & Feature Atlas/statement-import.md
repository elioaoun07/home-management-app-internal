...
- **Transfers is a TOP-LEVEL tab** (Review / Transfers / Imported / Logged / Skipped), not a Review sub-section — person-to-person transfers are a different kind of work from categorising spending, and burying them one level down is why they read as "missing".
