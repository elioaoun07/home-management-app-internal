...
export function MobileHome() {
  ...
  return <div class="m-home">
    ...
    <section class="m-section"><div class="m-section-head"><div class="eyebrow">Now lane</div><a href="#/work">All →</a></div>{nowTop.length ? <div class="task-lane-list">{nowTop.map((task) => <TaskCard task={task} key={task.key} />)}</div> : <div class="muted" style={{ fontSize: 12 }}>Nothing queued under Now.</div>}</section>
    ...
    <section class="m-section"><div class="m-section-head"><div class="eyebrow">Go to</div></div><div class="m-tiles"><a class="m-tile" href="#/work"><Icon name="tasks" /><span>Work queue</span></a><a class="m-tile" href="#/projects"><Icon name="projects" /><span>Projects</span></a>{isServer && <a class="m-tile" href="#/delivery"><Icon name="bolt" /><span>Delivery</span></a>}<a class="m-tile" href="#/activity"><Icon name="activity" /><span>Activity</span></a><a class="m-tile" href="#/search"><Icon name="search" /><span>Search</span></a></div></section>
    <section class="m-section"><div class="m-section-head"><div class="eyebrow">Campaigns</div><a href="#/projects">All →</a></div><div class="m-campaigns">{moduleStats.value.map((stat) => <a class="m-campaign" key={stat.module} href={`#/module/${encodeURIComponent(stat.module)}`}><span>{stat.module}</span><Chip>{stat.open} open</Chip></a>)}</div></section>
  </div>;
}
