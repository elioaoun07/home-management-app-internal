...
export function parseRoute(hash = "") {
  ...
  if (parts[0] === "work" && parts[1] === "item" && parts[2] && parts[3]) return { name: "work-item", campaign: parts[2], itemId: parts[3], path, query };
  ...
  if (["checklist", "bugs", "search", "inbox", "projects", "activity", "decisions"].includes(parts[0])) return { name: parts[0], path, query };
