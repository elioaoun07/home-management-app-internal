...
setTransport({
 ...
 v2Session:async()=>({paired:true}),v2Runs:async()=>({runs:[{run_id:"r-uat-preview",campaign:"Delivery",alias:"DLV-116",title:"Synthetic retained attempt",active:false,lifecycle:"CLOSED",branch:"rolled_back",executor:"codex",ownerAction:"Done"}]}),v2Run:async()=>detail,v2Queue:async()=>null,v2Assess:async()=>null,
...
if(!location.hash) location.hash="/explore?view=done";
