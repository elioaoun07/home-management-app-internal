...
export function NotificationSettings() {
  ...
  return (
    <div className="space-y-6">
      ...
      <details
        className={`p-3 rounded-xl ${themeClasses.bgSurface} ${themeClasses.border} border text-xs`}
      >
        <summary
          className={`cursor-pointer ${themeClasses.textMuted} select-none`}
        >
        ...
        <div className={`mt-2 space-y-1 font-mono ${themeClasses.textMuted}`}>
          <div>
            ...
            >
              {typeof window !== "undefined"
                ? localStorage.getItem("push_notifications_enabled") || "null"
                : "SSR"}
            </span>
          </div>
          <div>
