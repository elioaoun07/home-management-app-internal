...
const WebDashboard = memo(function WebDashboard({
  ...
  const categoryTrends = useMemo(() => {
    ...
    const midPoint = new Date(
      today.getTime() -
        (differenceInDays(today, parseISO(startDate)) / 2) *
          24 *
          60 *
          60 *
          1000,
      ...
      {dashboardView === "overview" && (
        <div className="max-w-7xl mx-auto px-4 py-4">
                ...
                <div>
                  ...
                  <div className="flex items-baseline gap-2">
                    ...
                    <span className="text-sm text-amber-400/70 tabular-nums">
                      {stats.total > 0
                        ? Math.round(
                            ((stats.topCategory?.amount || 0) / stats.total) *
                              100,
                          )
                        : 0}
                      %
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400">
                    {incomeExpenseSummary.incomeTransactions.length}{" "}
                    transactions
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400">
                    {incomeExpenseSummary.expenseTransactions.length}{" "}
                    transactions
                  </p>
                </div>
              </div>
                    ...
                    <div key={day} className="flex flex-col items-center">
                      ...
                      <div
                        ...
                        style={{
                          ...
                          color:
                            intensity > 0.5 ? "white" : "rgb(148, 163, 184)",
                        }}
                      >
          ...
          >
            <div className="flex items-center justify-between mb-3">
              <h3
                className={`text-sm font-semibold ${themeClasses.headerText}`}
              >
                Recent Transactions
              </h3>
              <span className="text-xs text-slate-400">
