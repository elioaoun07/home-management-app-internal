...
export default function WelcomeClient() {
  ...
  return (
    <main className="mx-auto w-full max-w-lg p-6 page-transition">
      ...
      {/* Individual option */}
      <section
        className={`rounded-md ${themeClasses.sectionCard} p-4 mb-4 transition-all duration-200 hover:-translate-y-0.5 animate-in fade-in slide-in-from-bottom-4`}
      ...
      {/* Household option */}
      <section
        className={`rounded-md ${themeClasses.sectionCard} p-4 space-y-6 transition-all duration-200 hover:-translate-y-0.5 animate-in fade-in slide-in-from-bottom-4`}
